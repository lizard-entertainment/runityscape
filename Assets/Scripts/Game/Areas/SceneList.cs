...
namespace Scripts.Game.Stages {
    ...
    public static class SceneList {
        ...
        public static SceneStage JavaCrypt1(Party party) {
            ...
            page.AddCharacters(Side.LEFT, party); // Party members on the left
            return new SceneStage(page, "Stanic Beginnings",
                    ...
                    new TextAct(friend, Side.RIGHT, "Uh, dude, what're you doing out here? It's like 1 AM?"),
        ...
        public static SceneStage JavaCrypt2(Party party) {
            ...
            return new SceneStage(page, "Stanic Reveal",
                    new TextAct(friend, Side.RIGHT, "We've mushed a lot of these things... Did you ever tell me what you're using them for?"),
        ...
        public static SceneStage ObjectiveSea2(Party party) {
            ...
            return new SceneStage(page, "Stanism hostage crisis",
                    ...
                    new TextAct("The two of you skip off merrily into the sunset, off to find a bio-weapon and engage in class warfare.")
                );
        }
        ...
        public static SceneStage Labs2(Party party) {
            ...
            return new SceneStage(page, "Stanist clones?",
                    ...
                    new TextAct(friend, Side.LEFT, "No, it's you! The bourgeoisie must've extracted the miniscule individualistic desire within you and used it as last-ditch effort to stall their eradication.")
                );
        }
        ...
        public static SceneStage Labs3(Party party) {
            ...
            return new SceneStage(page, "Gold-plated Stanism",
                new TextAct("You strike down your evil clone, composed of pure capitalism."),
                    ...
                    new TextAct(party.Default, Side.LEFT, "Come, comrade, let us bathe in the ketchup of our foes, and proclaim the rebirth of the collectivist society!"),
                    new TextAct("And all the bourgeoisie lost their ketchup."),
                    new TextAct("THE END")
                );
        }
    }
